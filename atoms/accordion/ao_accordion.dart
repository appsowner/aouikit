...
class AoAccordion extends StatefulWidget {
  final String title;
  final String subtitle;

  const AoAccordion({super.key, required this.title, required this.subtitle});

  @override
  State<AoAccordion> createState() => _AoAccordionState();
}

class _AoAccordionState extends State<AoAccordion> {
